...
<html>
<head>
	<title>LOVE DIGITAL GLORIETTA</title>
	<meta charset="utf-8">
...
<body>
	<div class="container-fluid">
		<h4 class="text-center">
		   LOVE DIGITAL ADMIN - GLORIETTA
		</h4>
		
		<div class="text-right">
		   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalNew">NEW</button>
		   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalWorking">WORKING</button>
		   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalDone">DONE</button>
		</div> <br>  
		...
		<table class="table table-bordered table-striped table-hover" id="table-data">
        	...
        	$get_data = "SELECT * FROM user_ayala";
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
	  ...
	  <table class="table table-bordered table-striped table-hover" id="table-data">
        	...
        	$get_data = "SELECT * FROM user_ayala where status='NEW'";
        	$run_data = mysqli_query($con,$get_data);
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
	  ...
	  <table class="table table-bordered table-striped table-hover" id="table-data">
        	...
        	$get_data = "SELECT * FROM user_ayala where status='Working'";
        	$run_data = mysqli_query($con,$get_data);
...
<div class="modal-content">
	  ...
	  <table class="table table-bordered table-striped table-hover" id="table-data">
        	...
        	$get_data = "SELECT * FROM user_ayala where status='Done'";
        	$run_data = mysqli_query($con,$get_data);
...
$get_data = "SELECT id,name,email,phone,address,status FROM user_ayala";
$run_data = mysqli_query($con,$get_data);
