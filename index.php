...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col" onclick="window.open('https://beta.theparcfoundation.ph/Temp1.php')" style="cursor: pointer;margin-bottom:20px">
    <div class="card h-80"  style="background-color: #E19ECE;">
      <img
        src="assets/img/Glo/Vday Thumbnail Glo_Vday_Template 01 (Phone).png"
  ...
  <div class="col" onclick="window.open('https://beta.theparcfoundation.ph/Temp2.php')" style="cursor: pointer;margin-bottom:20px">
  ...
  <div class="col" onclick="window.open('https://beta.theparcfoundation.ph/Temp3.php')" style="cursor: pointer;margin-bottom:20px">
    <div class="card h-80" style="background-color: #D81B71;">
      <img
        src="assets/img/Glo/Vday Thumbnail Glo_Vday_Template 03 (Phone).png"
      />
